...
func newHyperay(account *Account) Siter {
	return &hyperay{Account: account}
}
...
func (site *hyperay) Print() {
	fmt.Println(site.Account.Info)
}

func (site *hyperay) ExtractUID(doc *goquery.Document) { //UID
...
func (site *hyperay) ExtractUpload(doc *goquery.Document) { //上传量
...
func (site *hyperay) ExtractDownload(doc *goquery.Document) { //下载量
	doc.Find("table.mainouter td#outer table.main table td").Each(func(i int, s *goquery.Selection) {
		if 33 == i {
			rg, _ := regexp.Compile(`[0-9,.]+\s*[TGMK]B`)
...
func (site *hyperay) ExtractShare(doc *goquery.Document) { //分享率
	doc.Find("table.mainouter td#outer table.main table td").Each(func(i int, s *goquery.Selection) {
		if 30 == i {
...
func (site *hyperay) ExtractMagic(doc *goquery.Document) { //魔力值
	doc.Find("table.mainouter td#outer table.main table td").Each(func(i int, s *goquery.Selection) {
		if 56 == i {
			rg, _ := regexp.Compile(`[0-9,.]+`)
			rp, _ := regexp.Compile(`[,]+`)
...
func (site *hyperay) ExtractSeed(doc *goquery.Document) { //做种数
	// doc.Find("table.mainouter td#outer table.main table td").Each(func(i int, s *goquery.Selection) {
	// 	if 38 == i {
	// 		rg, _ := regexp.Compile(`^[0-9,]+`)
	// 		rp, _ := regexp.Compile(`[,]+`)
...
func (site *hyperay) ExtractBulk(doc *goquery.Document) { //体积
	// doc.Find("table.mainouter td#outer table.main table td").Each(func(i int, s *goquery.Selection) {
	// 	if 38 == i {
...
func (site *hyperay) ExtractDay(doc *goquery.Document) { //天数
	doc.Find("table.mainouter td#outer table.main table td").Each(func(i int, s *goquery.Selection) {
		if 43 == i {
			rg, _ := regexp.Compile(`\d+`)
...
func (site *hyperay) ExtractWeek(doc *goquery.Document) { //入站

}
func (site *hyperay) ExtractLevel(doc *goquery.Document) { //等级
